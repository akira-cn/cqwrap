...
cc.kmMat4Multiply=function(a,b,c){var d=a.mat,e=b.mat[0],f=b.mat[1],g=b.mat[2],h=b.mat[3],k=b.mat[4],l=b.mat[5],m=b.mat[6],n=b.mat[7],p=b.mat[8],q=b.mat[9],r=b.mat[10],s=b.mat[11],t=b.mat[12],u=b.mat[13],v=b.mat[14];b=b.mat[15];var x=c.mat[0],w=c.mat[1],z=c.mat[2],y=c.mat[3],E=c.mat[4],D=c.mat[5],F=c.mat[6],A=c.mat[7],B=c.mat[8],C=c.mat[9],H=c.mat[10],G=c.mat[11],I=c.mat[12],J=c.mat[13],K=c.mat[14];c=c.mat[15];d[0]=x*e+w*k+z*p+y*t;d[1]=x*f+w*l+z*q+y*u;d[2]=x*g+w*m+z*r+y*v;d[3]=x*h+w*n+z*s+y*b;d[4]=
E*e+D*k+F*p+A*t;d[5]=E*f+D*l+F*q+A*u;d[6]=E*g+D*m+F*r+A*v;d[7]=E*h+D*n+F*s+A*b;d[8]=B*e+C*k+H*p+G*t;d[9]=B*f+C*l+H*q+G*u;d[10]=B*g+C*m+H*r+G*v;d[11]=B*h+C*n+H*s+G*b;d[12]=I*e+J*k+K*p+c*t;d[13]=I*f+J*l+K*q+c*u;d[14]=I*g+J*m+K*r+c*v;d[15]=I*h+J*n+K*s+c*b;return a};
...
this._texCoordinateBuffer=a.createBuffer();this._indicesBuffer&&a.deleteBuffer(this._indicesBuffer);this._indicesBuffer=a.createBuffer();for(var g,h,k=this._indices,l=this._texCoordinates,m=this._isTextureFlipped,n=this._vertices,f=0;f<e.width;++f)for(g=0;g<e.height;++g){var p=g*e.width+f;h=f*this._step.x;var q=h+this._step.x,r=g*this._step.y,s=r+this._step.y,t=f*(e.height+1)+g,u=(f+1)*(e.height+1)+g,v=(f+1)*(e.height+1)+(g+1),x=f*(e.height+1)+(g+1);k[6*p]=t;k[6*p+1]=u;k[6*p+2]=x;k[6*p+3]=u;k[6*p+
4]=v;k[6*p+5]=x;var p=[3*t,3*u,3*v,3*x],w=[{x:h,y:r,z:0},{x:q,y:r,z:0},{x:q,y:s,z:0},{x:h,y:s,z:0}],t=[2*t,2*u,2*v,2*x],q=[cc.p(h,r),cc.p(q,r),cc.p(q,s),cc.p(h,s)];for(h=0;4>h;++h)n[p[h]]=w[h].x,n[p[h]+1]=w[h].y,n[p[h]+2]=w[h].z,l[t[h]]=q[h].x/b,l[t[h]+1]=m?(d-q[h].y)/c:q[h].y/c}this._originalVertices=new Float32Array(this._vertices);a.bindBuffer(a.ARRAY_BUFFER,this._verticesBuffer);a.bufferData(a.ARRAY_BUFFER,this._vertices,a.DYNAMIC_DRAW);a.bindBuffer(a.ARRAY_BUFFER,this._texCoordinateBuffer);a.bufferData(a.ARRAY_BUFFER,
...
m=this._vertices,n=this._texCoordinates,p=this._isTextureFlipped;for(g=0;g<d.width;g++)for(h=0;h<d.height;h++){var q=g*l.x,r=q+l.x,s=h*l.y,t=s+l.y;m[12*k]=q;m[12*k+1]=s;m[12*k+2]=0;m[12*k+3]=r;m[12*k+4]=s;m[12*k+5]=0;m[12*k+6]=q;m[12*k+7]=t;m[12*k+8]=0;m[12*k+9]=r;m[12*k+10]=t;m[12*k+11]=0;var u=s,v=t;p&&(u=c-s,v=c-t);n[8*k]=q/a;n[8*k+1]=u/b;n[8*k+2]=r/a;n[8*k+3]=u/b;n[8*k+4]=q/a;n[8*k+5]=v/b;n[8*k+6]=r/a;n[8*k+7]=v/b;k++}a=this._indices;for(g=0;g<e;g++)a[6*g+0]=4*g+0,a[6*g+1]=4*g+1,a[6*g+2]=4*g+
...
(p=(2*p*f+1)/(2*e),n=p+(2*f-2)/(2*e),q=(2*q*g+1)/(2*d),r=q+(2*g-2)/(2*d)):(p=p*f/e,n=p+f/e,q=q*g/d,r=q+g/d);var s=h[m],t=s.tl,u=s.tr,v=s.bl,s=s.br;t.texCoords.u=p;t.texCoords.v=q;u.texCoords.u=n;u.texCoords.v=q;v.texCoords.u=p;v.texCoords.v=r;s.texCoords.u=n;s.texCoords.v=r;v.vertices.x=m*l;v.vertices.y=0;v.vertices.z=0;s.vertices.x=m*l+l;s.vertices.y=0;s.vertices.z=0;t.vertices.x=m*l;t.vertices.y=this._itemHeight;t.vertices.z=0;u.vertices.x=m*l+l;u.vertices.y=this._itemHeight;u.vertices.z=0;t.colors=
k;u.colors=k;v.colors=k;s.colors=k}0<b&&(c.setDirty(!0),a=c.getTotalQuads(),b>a&&c.increaseTotalQuadsWith(b-a))},setString:null,_setStringForCanvas:function(a){a=String(a);var b=a.length;this._string=a;this.setContentSize(b*this._itemWidth,this._itemHeight);if(this._children){a=this._children;for(var b=a.length,c=0;c<b;c++){var d=a[c];d&&d.setVisible(!1)}}this.updateAtlasValues();this._quadsToDraw=b},_setStringForWebGL:function(a){a=String(a);var b=a.length;b>this._textureAtlas.getTotalQuads()&&this._textureAtlas.resizeCapacity(b);
...
d.SamplesPerPixel.values[0],k=[],l=0,m=!1;d.BitsPerSample.values.forEach(function(a,b,c){k[b]={bitsPerSample:a,hasBytesPerSample:!1,bytesPerSample:void 0};0===a%8&&(k[b].hasBytesPerSample=!0,k[b].bytesPerSample=a/8);l+=a},this);if(0===l%8)var m=!0,n=l/8;var p=d.StripOffsets.values,q=p.length;if(d.StripByteCounts)var r=d.StripByteCounts.values;else if(cc.log("Missing StripByteCounts!"),1===q)r=[Math.ceil(c*e*l/8)];else throw Error("Cannot recover from missing StripByteCounts");for(var s=0;s<q;s++){var t=
p[s];f[s]=[];for(var u=r[s],v=0,x=0,w=1,z=!0,y=[],E=0,D=0,F=0;v<u;v+=w)switch(g){case 1:w=0;for(y=[];w<h;w++)if(k[w].hasBytesPerSample)y.push(this.getBytes(k[w].bytesPerSample,t+v+k[w].bytesPerSample*w));else{var A=this.getBits(k[w].bitsPerSample,t+v,x);y.push(A.bits);v=A.byteOffset-t;x=A.bitOffset;throw RangeError("Cannot handle sub-byte bits per sample");}f[s].push(y);if(m)w=n;else throw w=0,RangeError("Cannot handle sub-byte bits per pixel");break;case 32773:if(z){var z=!1,B=1,C=1,w=this.getInt8(t+
v);0<=w&&127>=w?B=w+1:-127<=w&&-1>=w?C=-w+1:z=!0}else{for(var H=this.getUint8(t+v),w=0;w<C;w++){if(k[D].hasBytesPerSample)F=F<<8*E|H,E++,E===k[D].bytesPerSample&&(y.push(F),F=E=0,D++);else throw RangeError("Cannot handle sub-byte bits per sample");D===h&&(f[s].push(y),y=[],D=0)}B--;0===B&&(z=!0)}w=1}}if(b.getContext){n=this.canvas.getContext("2d");n.fillStyle="rgba(255, 255, 255, 0)";s=d.RowsPerStrip?d.RowsPerStrip.values[0]:e;t=f.length;e%=s;e=0===e?s:e;v=s;g=0;y=d.PhotometricInterpretation.values[0];
B=[];C=0;d.ExtraSamples&&(B=d.ExtraSamples.values,C=B.length);if(d.ColorMap)var A=d.ColorMap.values,G=Math.pow(2,k[0].bitsPerSample);for(s=0;s<t;s++){s+1===t&&(v=e);d=f[s].length;g*=s;for(m=h=0;h<v,m<d;h++)for(p=0;p<c;p++,m++){r=f[s][m];z=x=u=0;q=1;if(0<C)for(u=0;u<C;u++)if(1===B[u]||2===B[u]){q=r[3+u]/256;break}switch(y){case 0:if(k[0].hasBytesPerSample)var I=Math.pow(16,2*k[0].bytesPerSample);r.forEach(function(a,b,c){c[b]=I-a});case 1:u=x=z=this.clampColorSample(r[0],k[0].bitsPerSample);break;
case 2:u=this.clampColorSample(r[0],k[0].bitsPerSample);x=this.clampColorSample(r[1],k[1].bitsPerSample);z=this.clampColorSample(r[2],k[2].bitsPerSample);break;case 3:if(void 0===A)throw Error("Palette image missing color map");r=r[0];u=this.clampColorSample(A[r],16);x=this.clampColorSample(A[G+r],16);z=this.clampColorSample(A[2*G+r],16);break;default:throw RangeError("Unknown Photometric Interpretation:",y);}n.fillStyle="rgba("+u+", "+x+", "+z+", "+q+")";n.fillRect(p,g+h,1,1)}g=v}}return this.canvas}},
